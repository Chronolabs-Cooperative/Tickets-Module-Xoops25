 ...
 */
class ticketsCorrespondences_contents extends ticketsXoopsObject
{
 ...
 * @copyright copyright (c) 2015 labs.coop
 */
class ticketsCorrespondences_contentsHandler extends ticketsXoopsObjectHandler
{
	 ...
	 * @var string
	 */
	var $tbl = 'tickets_correspondences_contents';
	 ...
	 * @var string
	 */
	var $child = 'ticketsCorrespondences_contents';
