 ...
 */
class ticketsWiki_keywords extends ticketsXoopsObject
{
 ...
 * @copyright copyright (c) 2015 labs.coop
 */
class ticketsWiki_keywordsHandler extends ticketsXoopsObjectHandler
{
	 ...
	 * @var string
	 */
	var $child = 'ticketsWiki_keywords';
