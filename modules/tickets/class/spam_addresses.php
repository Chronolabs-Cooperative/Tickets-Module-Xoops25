 ...
 */
class ticketsSpam_addresses extends ticketsXoopsObject
{
 ...
 * @copyright copyright (c) 2015 labs.coop
 */
class ticketsSpam_addressesHandler extends ticketsXoopsObjectHandler
{
	 ...
	 * @var string
	 */
	var $tbl = 'tickets_Spam_addresses';
	 ...
	 * @var string
	 */
	var $child = 'ticketsSpam_addresses';
