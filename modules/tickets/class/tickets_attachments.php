 ...
 */
class ticketsTickets_attachments extends ticketsXoopsObject
{
 ...
 * @copyright copyright (c) 2015 labs.coop
 */
class ticketsTickets_attachmentsHandler extends ticketsXoopsObjectHandler
{
	 ...
	 * @var string
	 */
	var $tbl = 'tickets_tickets_attachments';
	 ...
	 * @var string
	 */
	var $child = 'ticketsTickets_attachments';
