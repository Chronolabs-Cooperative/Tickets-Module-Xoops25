 ...
 */
class ticketsCorrespondences_cc extends ticketsXoopsObject
{
 ...
 * @copyright copyright (c) 2015 labs.coop
 */
class ticketsCorrespondences_ccHandler extends ticketsXoopsObjectHandler
{
	 ...
	 * @var string
	 */
	var $tbl = 'tickets_correspondences_cc';
	 ...
	 * @var string
	 */
	var $child = 'ticketsCorrespondences_cc';
