 ...
 */
class ticketsTickets_departments extends ticketsXoopsObject
{
 ...
 * @copyright copyright (c) 2015 labs.coop
 */
class ticketsTickets_departmentsHandler extends ticketsXoopsObjectHandler
{
	 ...
	 * @var string
	 */
	var $tbl = 'tickets_tickets_departments';
	 ...
	 * @var string
	 */
	var $child = 'ticketsTickets_departments';
