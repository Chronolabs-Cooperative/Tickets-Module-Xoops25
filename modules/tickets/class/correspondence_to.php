 ...
 */
class ticketsCorrespondences_to extends ticketsXoopsObject
{
 ...
 * @copyright copyright (c) 2015 labs.coop
 */
class ticketsCorrespondences_toHandler extends ticketsXoopsObjectHandler
{
	 ...
	 * @var string
	 */
	var $tbl = 'tickets_correspondences_to';
	 ...
	 * @var string
	 */
	var $child = 'ticketsCorrespondences_to';
