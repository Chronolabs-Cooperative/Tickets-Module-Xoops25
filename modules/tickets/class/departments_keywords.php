 ...
 */
class ticketsDepartments_keywords extends ticketsXoopsObject
{
 ...
 * @copyright copyright (c) 2015 labs.coop
 */
class ticketsDepartments_keywordsHandler extends ticketsXoopsObjectHandler
{
	 ...
	 * @var string
	 */
	var $tbl = 'tickets_departments_keywords';
	 ...
	 * @var string
	 */
	var $child = 'ticketsDepartments_keywords';
