 ...
 */
class ticketsSpam_keywords extends ticketsXoopsObject
{
 ...
 * @copyright copyright (c) 2015 labs.coop
 */
class ticketsSpam_keywordsHandler extends ticketsXoopsObjectHandler
{
	 ...
	 * @var string
	 */
	var $child = 'ticketsSpam_keywords';
