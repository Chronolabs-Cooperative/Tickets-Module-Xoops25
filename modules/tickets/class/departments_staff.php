 ...
 */
class ticketsDepartments_staff extends ticketsXoopsObject
{
 ...
 * @copyright copyright (c) 2015 labs.coop
 */
class ticketsDepartments_staffHandler extends ticketsXoopsObjectHandler
{
	 ...
	 * @var string
	 */
	var $tbl = 'tickets_departments_staff';
	 ...
	 * @var string
	 */
	var $child = 'ticketsDepartments_staff';
