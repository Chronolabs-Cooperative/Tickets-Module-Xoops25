 ...
 */
class ticketsDepartments_staff_keywords extends ticketsXoopsObject
{
 ...
 * @copyright copyright (c) 2015 labs.coop
 */
class ticketsDepartments_staff_keywordsHandler extends ticketsXoopsObjectHandler
{
	 ...
	 * @var string
	 */
	var $tbl = 'tickets_departments_staff_keywords';
	 ...
	 * @var string
	 */
	var $child = 'ticketsDepartments_staff_keywords';
