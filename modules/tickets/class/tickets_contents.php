 ...
 */
class ticketsTickets_contents extends ticketsXoopsObject
{
 ...
 * @copyright copyright (c) 2015 labs.coop
 */
class ticketsTickets_contentsHandler extends ticketsXoopsObjectHandler
{
	 ...
	 * @var string
	 */
	var $tbl = 'tickets_tickets_contents';
	 ...
	 * @var string
	 */
	var $child = 'ticketsTickets_contents';
